...
<<<<<<< HEAD
<<<<<<< HEAD:coordinator/app/src/main/kotlin/lineth/coordinator/config/v2/toml/Type2StateProofManagerToml.kt
=======
import linea.coordinator.config.v2.Type2StateProofManagerConfig
>>>>>>> abc0edd8e (feat(coordinator): document all TOML config keys with @ConfigDoc/@ConfigSection (#3568)):coordinator/app/src/main/kotlin/linea/coordinator/config/v2/toml/Type2StateProofManagerToml.kt
=======
