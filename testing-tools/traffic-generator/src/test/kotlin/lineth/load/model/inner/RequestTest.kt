...
class RequestTest {
  ...
  fun translateCreateContractWithoutGasLimitFailsWithClearError() {
    ...
    val swaggerRequest =
      JSON.createGson().create().fromJson(requestJson, lineth.load.swagger.Request::class.java)
  ...
  private fun loadRequestFromResource(path: String): lineth.load.swagger.Request {
