...
class RequestTest {
  ...
  fun translateCreateContractWithoutGasLimitFailsWithClearError() {
    ...
    val swaggerRequest =
      JSON.createGson().create().fromJson(requestJson, lineth.zkevm.load.swagger.Request::class.java)
  ...
  private fun loadRequestFromResource(path: String): lineth.zkevm.load.swagger.Request {
