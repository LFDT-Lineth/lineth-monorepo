...
import lineth.load.model.CreateWallets.createWallets
import lineth.load.model.EthConnection
import lineth.load.model.EthConnectionImpl
import lineth.load.model.ExecutionDetails
import lineth.load.model.JSON
import lineth.load.model.SmartContractCalls
import lineth.load.model.TransactionDetail
import lineth.load.model.Wallet
import lineth.load.model.inner.BatchMint
import lineth.load.model.inner.CallContractReference
import lineth.load.model.inner.CallExistingContract
import lineth.load.model.inner.ContractCall
import lineth.load.model.inner.CreateContract
import lineth.load.model.inner.GenericCall
import lineth.load.model.inner.MethodAndParameter
import lineth.load.model.inner.Mint
import lineth.load.model.inner.NEW
import lineth.load.model.inner.Request
import lineth.load.model.inner.RoundRobinMoneyTransfer
import lineth.load.model.inner.Scenario
import lineth.load.model.inner.ScenarioDefinition
import lineth.load.model.inner.SelfTransactionWithPayload
import lineth.load.model.inner.SelfTransactionWithRandomPayload
import lineth.load.model.inner.TransferOwnerShip
    ...
    if (resource != null) {
      return Request.translate(
        builder.create().fromJson(
          ...
          lineth.load.swagger.Request::class.java,
        ),
      )
    } else {
      ...
      return Request.translate(
        builder.create()
          .fromJson(reader, lineth.load.swagger.Request::class.java),
      )
    }
  }
