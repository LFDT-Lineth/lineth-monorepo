package lineth.zkevm.load

import lineth.zkevm.load.model.CreateWallets.createWallets
import lineth.zkevm.load.model.EthConnection
import lineth.zkevm.load.model.EthConnectionImpl
import lineth.zkevm.load.model.ExecutionDetails
import lineth.zkevm.load.model.JSON
import lineth.zkevm.load.model.SmartContractCalls
import lineth.zkevm.load.model.TransactionDetail
import lineth.zkevm.load.model.Wallet
import lineth.zkevm.load.model.inner.BatchMint
import lineth.zkevm.load.model.inner.CallContractReference
import lineth.zkevm.load.model.inner.CallExistingContract
import lineth.zkevm.load.model.inner.ContractCall
import lineth.zkevm.load.model.inner.CreateContract
import lineth.zkevm.load.model.inner.GenericCall
import lineth.zkevm.load.model.inner.MethodAndParameter
import lineth.zkevm.load.model.inner.Mint
import lineth.zkevm.load.model.inner.NEW
import lineth.zkevm.load.model.inner.Request
import lineth.zkevm.load.model.inner.RoundRobinMoneyTransfer
import lineth.zkevm.load.model.inner.Scenario
import lineth.zkevm.load.model.inner.ScenarioDefinition
import lineth.zkevm.load.model.inner.SelfTransactionWithPayload
import lineth.zkevm.load.model.inner.SelfTransactionWithRandomPayload
import lineth.zkevm.load.model.inner.TransferOwnerShip
    ...
    if (resource != null) {
      return Request.translate(
        builder.create().fromJson(
          ...
          lineth.zkevm.load.swagger.Request::class.java,
        ),
      )
    } else {
      ...
      return Request.translate(
        builder.create()
          .fromJson(reader, lineth.zkevm.load.swagger.Request::class.java),
      )
    }
  }
