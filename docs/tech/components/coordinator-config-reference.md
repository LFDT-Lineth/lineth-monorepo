...
| `prover.fork-name` | `String?` | no | - | active | L2 EVM fork name included in RISC-V execution proof requests (e.g. "cancun"). Required for the RISC-V prover; omit for the standard prover. Example: `cancun`. |
...
| `prover.new.fork-name` | `String?` | no | - | active | L2 EVM fork name included in RISC-V execution proof requests (e.g. "cancun"). Required for the RISC-V prover; omit for the standard prover. Example: `cancun`. |
...
| `riscv-prover.fork-name` | `String?` | no | - | active | L2 EVM fork name included in RISC-V execution proof requests (e.g. "cancun"). Required for the RISC-V prover; omit for the standard prover. Example: `cancun`. |
...
| `riscv-prover.new.fork-name` | `String?` | no | - | active | L2 EVM fork name included in RISC-V execution proof requests (e.g. "cancun"). Required for the RISC-V prover; omit for the standard prover. Example: `cancun`. |
