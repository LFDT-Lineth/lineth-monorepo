...
| LINETH_ROLLUP_ADDRESS | registry\|env | address | LineaRollup contract address to forward calls to. Read from registry on stable networks; env var used as fallback. |
