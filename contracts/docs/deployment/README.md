...
This document aims to explain how to get started with deploying the Lineth deployment scripts. There are several ways the scripts can be executed dependent on: 
