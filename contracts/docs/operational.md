...
This document aims to explain how to run the Lineth operational scripts. There are several ways the scripts can be executed dependent if you have an environment file (.env) or not. 
