...
export const SET_VERIFIER_KEY_ROLE = generateKeccak256(["string"], ["SET_VERIFIER_KEY_ROLE"], true);
export const UNSET_VERIFIER_KEY_ROLE = generateKeccak256(["string"], ["UNSET_VERIFIER_KEY_ROLE"], true);
