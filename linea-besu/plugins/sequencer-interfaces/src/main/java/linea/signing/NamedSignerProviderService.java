 ...
 *
 * <p>Implementations own provider-specific configuration and signer lifecycle. A returned signer's
 * public key must be ready for synchronous access and encoded as the 64-byte unsigned secp256k1
 * coordinates {@code x || y}.
 */
public interface NamedSignerProviderService extends BesuService {
  /**
   ...
   */
  Signer<Secp256k1Signature> create(String name);
}
