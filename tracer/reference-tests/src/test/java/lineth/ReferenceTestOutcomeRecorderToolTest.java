...
import static lineth.BlockchainReferenceTestJson.readBlockchainReferenceTestsOutput;
import static lineth.ReferenceTestOutcomeRecorderTool.JSON_OUTPUT_FILENAME;
...
import lineth.reporting.TestOutcome;
import lineth.reporting.TestOutcomeWriterTool;
import lineth.reporting.TestState;
  ...
  public void extractConstraints() {
    String message =
        "\u001B[1m\u001B[31mrlptxrcpt.phase3\u001B[39m\u001B[0m failed:\n"
            ...
            + "]"
            + "      at app//lineth.testing.ExecutionEnvironment.checkTracer(ExecutionEnvironment.java:72)\n"
            + "      at app//lineth.GeneralStateReferenceTestTools.executeTest(GeneralStateReferenceTestTools.java:235)\n"
            + "      at app//lineth.generated.generalstate.GeneralStateReferenceTest_200.execution(GeneralStateReferenceTest_200.java:60)\n"
