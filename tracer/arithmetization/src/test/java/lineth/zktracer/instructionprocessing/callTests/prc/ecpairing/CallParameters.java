 ...
 */
package lineth.zktracer.instructionprocessing.callTests.prc.ecpairing;

import static lineth.zktracer.Trace.*;
import static lineth.zktracer.instructionprocessing.callTests.prc.ecpairing.MemoryContents.SIZE_OF_PAIR_OF_POINTS;
import static lineth.zktracer.instructionprocessing.callTests.prc.ecpairing.MemoryContents.TOTAL_NUMBER_OF_PAIRS_OF_POINTS;
import static lineth.zktracer.opcode.OpCode.DIV;
import static lineth.zktracer.opcode.OpCode.GAS;

import lineth.testing.BytecodeCompiler;
import lineth.zktracer.instructionprocessing.callTests.prc.GasParameter;
import lineth.zktracer.instructionprocessing.callTests.prc.ReturnAtParameter;
import lineth.zktracer.instructionprocessing.callTests.prc.framework.PrecompileCallMemoryContents;
import lineth.zktracer.instructionprocessing.callTests.prc.framework.PrecompileCallParameters;
