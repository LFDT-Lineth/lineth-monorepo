...
import static lineth.zktracer.Fork.*;
import static lineth.zktracer.Trace.BLOCKHASH_MAX_HISTORY;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECPAIRING_DATA_MIN;
import static lineth.zktracer.Trace.PRECOMPILE_CALL_DATA_SIZE___P256_VERIFY;
import static lineth.zktracer.module.ModuleName.*;
import static lineth.zktracer.module.ModuleName.ADD;
import static lineth.zktracer.module.ModuleName.EXP;
import static lineth.zktracer.module.ModuleName.GAS;
import static lineth.zktracer.module.ModuleName.MOD;
import static lineth.zktracer.module.ModuleName.MUL;
import static lineth.zktracer.module.add.AddOperation.NB_ROWS_ADD;
import static lineth.zktracer.module.blake2fmodexpdata.BlakeModexpDataOperation.*;
import static lineth.zktracer.module.blockdata.module.CancunBlockData.NB_ROWS_BLOCK_DATA;
import static lineth.zktracer.module.blockhash.BlockhashOperation.NB_ROWS_BLOCKHASH;
import static lineth.zktracer.module.gas.GasOperation.NB_ROWS_GAS;
import static lineth.zktracer.module.hub.fragment.scenario.PrecompileScenarioFragment.PrecompileFlag.*;
import static lineth.zktracer.module.hub.section.AccountSection.NB_ROWS_HUB_ACCOUNT;
import static lineth.zktracer.module.hub.section.CallDataLoadSection.NB_ROWS_HUB_CALLDATALOAD;
import static lineth.zktracer.module.hub.section.CreateSection.NB_ROWS_HUB_CREATE;
import static lineth.zktracer.module.hub.section.JumpSection.NB_ROWS_HUB_JUMP;
import static lineth.zktracer.module.hub.section.McopySection.NB_ROWS_HUB_MCOPY;
import static lineth.zktracer.module.hub.section.MsizeSection.NB_ROWS_HUB_MSIZE;
import static lineth.zktracer.module.hub.section.SstoreSection.NB_ROWS_HUB_STORAGE;
import static lineth.zktracer.module.hub.section.StackOnlySection.NB_ROWS_HUB_SIMPLE_STACK_OP;
import static lineth.zktracer.module.hub.section.StackRamSection.NB_ROWS_HUB_STACKRAM;
import static lineth.zktracer.module.hub.section.TxFinalizationSection.NB_ROWS_HUB_FINL;
import static lineth.zktracer.module.hub.section.TxInitializationSection.NB_ROWS_HUB_INIT;
import static lineth.zktracer.module.hub.section.TxSkipSection.NB_ROWS_HUB_SKIP;
import static lineth.zktracer.module.hub.section.call.CallSection.NB_ROWS_HUB_CALL;
import static lineth.zktracer.module.hub.section.call.precompileSubsection.BlakeSubsection.NB_ROWS_HUB_PRC_BLAKE;
import static lineth.zktracer.module.hub.section.call.precompileSubsection.EllipticCurvePrecompileSubsection.NB_ROWS_HUB_PRC_ELLIPTIC_CURVE;
import static lineth.zktracer.module.hub.section.call.precompileSubsection.IdentitySubsection.NB_ROWS_HUB_PRC_IDENTITY;
import static lineth.zktracer.module.hub.section.call.precompileSubsection.ModexpSubsection.NB_ROWS_HUB_PRC_MODEXP;
import static lineth.zktracer.module.hub.section.call.precompileSubsection.ShaTwoOrRipemdSubSection.NB_ROWS_HUB_PRC_SHARIP;
import static lineth.zktracer.module.hub.section.copy.CallDataCopySection.NB_ROWS_HUB_CALL_DATA_COPY;
import static lineth.zktracer.module.hub.section.copy.CodeCopySection.NB_ROWS_HUB_CODE_COPY;
import static lineth.zktracer.module.hub.section.copy.ExtCodeCopySection.NB_ROWS_HUB_EXT_CODE_COPY;
import static lineth.zktracer.module.hub.section.copy.ReturnDataCopySection.NB_ROWS_HUB_RETURN_DATA_COPY;
import static lineth.zktracer.module.hub.section.halt.RevertSection.NB_ROWS_HUB_REVERT;
import static lineth.zktracer.module.hub.section.halt.SelfdestructSection.NB_ROWS_HUB_SELFDESTRUCT;
import static lineth.zktracer.module.hub.section.halt.StopSection.NB_ROWS_HUB_STOP_DEPLOYMENT;
import static lineth.zktracer.module.hub.section.halt.StopSection.NB_ROWS_HUB_STOP_MSG_CALL;
import static lineth.zktracer.module.hub.section.systemTransaction.EIP2935HistoricalHash.NB_ROWS_HUB_SYSI_EIP_2935;
import static lineth.zktracer.module.hub.section.systemTransaction.EIP4788BeaconBlockRootSection.NB_ROWS_HUB_SYSI_EIP_4788;
import static lineth.zktracer.module.hub.section.systemTransaction.SysfNoopSection.NB_ROWS_HUB_SYSF_NOOP;
import static lineth.zktracer.module.hub.section.transients.TLoadSection.NB_ROWS_HUB_TLOAD;
import static lineth.zktracer.module.hub.section.transients.TStoreSection.NB_ROWS_HUB_TSTORE;
import static lineth.zktracer.module.logdata.LogData.lineCountForLogData;
import static lineth.zktracer.module.loginfo.LogInfo.lineCountForLogInfo;
import static lineth.zktracer.module.mxp.moduleCall.CancunMSizeMxpCall.NB_ROWS_MXP_MSIZE;
import static lineth.zktracer.module.mxp.moduleCall.CancunStateUpdateMxpCall.NB_ROWS_MXP_UPDT_B;
import static lineth.zktracer.module.mxp.moduleCall.CancunStateUpdateWordPricingMxpCall.NB_ROWS_MXP_UPDT_W;
import static lineth.zktracer.module.rlpaddr.RlpAddrOperation.*;
import static lineth.zktracer.module.rlptxrcpt.RlpTxrcptOperation.lineCountForRlpTxnRcpt;
import static lineth.zktracer.module.shakiradata.ShakiraDataOperation.NB_ROWS_SHAKIRA_RESULT;
import static lineth.zktracer.module.stp.StpOperation.NB_ROWS_STP;
import static lineth.zktracer.module.txndata.transactions.SysfNoopTransaction.NB_ROWS_TXN_DATA_SYSF_NOOP;
import static lineth.zktracer.module.txndata.transactions.SysiEip2935Transaction.NB_ROWS_TXN_DATA_SYSI_EIP_2935;
import static lineth.zktracer.module.txndata.transactions.SysiEip4788Transaction.NB_ROWS_TXN_DATA_SYSI_EIP_4788;
import static lineth.zktracer.module.txndata.transactions.UserTransaction.NB_ROWS_TXN_DATA_OSAKA_USER_1559_SEMANTIC;
import static lineth.zktracer.module.txndata.transactions.UserTransaction.NB_ROWS_TXN_DATA_OSAKA_USER_NO_1559_SEMANTIC;
import static lineth.zktracer.opcode.OpCode.*;
import static lineth.zktracer.runtime.stack.Stack.MAX_STACK_SIZE;
...
import lineth.zktracer.module.blsdata.BlsData;
...
import lineth.zktracer.module.limits.BlockTransactions;
import lineth.zktracer.module.limits.Keccak;
import lineth.zktracer.module.limits.L1BlockSize;
