...
package lineth.zktracer.module.ecdata;

import static com.google.common.base.Preconditions.*;
import static lineth.zktracer.Trace.Ecdata.CT_MAX_LARGE_POINT;
import static lineth.zktracer.Trace.Ecdata.CT_MAX_SMALL_POINT;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECADD_DATA;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECADD_RESULT;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECMUL_DATA;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECMUL_RESULT;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECPAIRING_DATA_MIN;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECPAIRING_RESULT;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECRECOVER_DATA;
import static lineth.zktracer.Trace.Ecdata.INDEX_MAX_ECRECOVER_RESULT;
import static lineth.zktracer.Trace.Ecdata.P_BN_HI;
import static lineth.zktracer.Trace.Ecdata.P_BN_LO;
import static lineth.zktracer.Trace.Ecdata.SECP256K1N_HI;
import static lineth.zktracer.Trace.Ecdata.SECP256K1N_LO;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECADD_DATA;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECADD_RESULT;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECMUL_DATA;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECMUL_RESULT;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECPAIRING_DATA_MIN;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECPAIRING_RESULT;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECRECOVER_DATA;
import static lineth.zktracer.Trace.Ecdata.TOTAL_SIZE_ECRECOVER_RESULT;
import static lineth.zktracer.Trace.PHASE_ECADD_DATA;
import static lineth.zktracer.Trace.PHASE_ECADD_RESULT;
import static lineth.zktracer.Trace.PHASE_ECMUL_DATA;
import static lineth.zktracer.Trace.PHASE_ECMUL_RESULT;
import static lineth.zktracer.Trace.PHASE_ECPAIRING_DATA;
import static lineth.zktracer.Trace.PHASE_ECPAIRING_RESULT;
import static lineth.zktracer.Trace.PHASE_ECRECOVER_DATA;
import static lineth.zktracer.Trace.PHASE_ECRECOVER_RESULT;
import static lineth.zktracer.Trace.PHASE_P256_VERIFY_DATA;
import static lineth.zktracer.Trace.PHASE_P256_VERIFY_RESULT;
import static lineth.zktracer.TraceOsaka.Ecdata.A_COEFF_R1_HI;
import static lineth.zktracer.TraceOsaka.Ecdata.A_COEFF_R1_LO;
import static lineth.zktracer.TraceOsaka.Ecdata.B_COEFF_R1_HI;
import static lineth.zktracer.TraceOsaka.Ecdata.B_COEFF_R1_LO;
import static lineth.zktracer.TraceOsaka.Ecdata.INDEX_MAX_P256_VERIFY_DATA;
import static lineth.zktracer.TraceOsaka.Ecdata.INDEX_MAX_P256_VERIFY_RESULT;
import static lineth.zktracer.TraceOsaka.Ecdata.P_R1_HI;
import static lineth.zktracer.TraceOsaka.Ecdata.P_R1_LO;
import static lineth.zktracer.TraceOsaka.Ecdata.SECP256R1N_HI;
import static lineth.zktracer.TraceOsaka.Ecdata.SECP256R1N_LO;
import static lineth.zktracer.TraceOsaka.Ecdata.TOTAL_SIZE_P256_VERIFY_DATA;
import static lineth.zktracer.TraceOsaka.Ecdata.TOTAL_SIZE_P256_VERIFY_RESULT;
