...
import static lineth.zktracer.Trace.GAS_CONST_PER_EMPTY_ACCOUNT;
import static lineth.zktracer.module.hub.section.TupleAnalysis.*;
...
public class TxAuthorizationMacroSection {
  ...
  public TxAuthorizationMacroSection(
     ...
     * lineth.zktracer.module.hub.fragment.account.AccountFragment}
     */
