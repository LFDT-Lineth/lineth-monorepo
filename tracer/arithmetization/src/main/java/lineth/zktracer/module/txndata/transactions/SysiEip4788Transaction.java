 ...
 */
package lineth.zktracer.module.txndata.transactions;

import static lineth.zktracer.Trace.HISTORY_BUFFER_LENGTH;
import static lineth.zktracer.module.hub.TransactionProcessingType.SYSI;
import static lineth.zktracer.module.hub.section.systemTransaction.EIP4788BeaconBlockRootSection.HISTORY_BUFFER_LENGTH_BI;
import static lineth.zktracer.module.txndata.rows.computationRows.EucRow.callToEuc;
import static lineth.zktracer.module.txndata.rows.computationRows.WcpRow.smallCallToIszero;
import static lineth.zktracer.module.txndata.rows.hubRows.Type.EIP4788;
...
import lineth.zktracer.module.txndata.rows.hubRows.HubRowForSystemTransactions;
