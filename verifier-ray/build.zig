...
pub fn build(b: *std.Build) void {
    ...
    const test_pcs_integration_mod = b.addModule("test_pcs_integration", .{
        .root_source_file = b.path("testdata/generated/pcs_integration.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "verifier_ray", .module = verifier_mod },
        ...
        const unit_tests = b.addTest(.{
            .root_module = b.createModule(.{
                ...
                .imports = &.{
                    ...
                    .{ .name = "test_pcs_integration", .module = test_pcs_integration_mod },
                },
            }),
        });
