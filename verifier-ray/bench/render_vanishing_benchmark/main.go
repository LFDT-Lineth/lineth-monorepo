...
func main() {
	...
	metadataPath := flag.String("metadata", "", "generated verifier Zig fixture path")
	...
	fmt.Fprintln(&out)
	fmt.Fprintln(&out, "This measures the RISC-V instruction count for the typed vanishing benchmark guest. The proof/system data is embedded as shared generated verifier fixture data. The report splits transcript coin replay from `vanishing.verify`; both are measured inside the same R5 run.")
	fmt.Fprintln(&out)
