...
pub fn build(b: *std.Build) void {
    ...
    // ../../build.zig. Unlike bench_compress, accelerators default ON: this
    // benchmark measures representative production hashing cost, not a
    // software/hardware comparison, and production would always use the
    // accelerated Poseidon2 path for payload hashing.
    ...
    common.installGuestElf(b, main_mod, "bench-hash");
}
