// Runner for the bench_zstd micro-benchmark.
...
const (
	...
	r5Bin         = "zig-out/bin/bench-zstd"
	r5JSON        = "zig-out/bin/bench-zstd.json"
	tailLimit     = 40
	defaultOutput = "bench/bench-zstd.csv"
...
var phases = []struct {
	...
	{"zstd -19 (no dictionary)", 10, 11, 12, "zstd_compressed.bin"},
}
...
func main() {
	...
	fmt.Fprintln(os.Stderr, "running zkc (this decodes 780,000 bytes; expect a few minutes)...")
