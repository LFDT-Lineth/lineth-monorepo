// Runner for the bench_lz4 micro-benchmark.
...
const (
	...
	r5Bin         = "zig-out/bin/bench-lz4"
	r5JSON        = "zig-out/bin/bench-lz4.json"
	tailLimit     = 40
	defaultOutput = "bench/bench-lz4.csv"
...
var phases = []struct {
	...
	{"lz4 HC-9", 10, 11, 12, "compressed_block.bin"},
}
...
func main() {
	...
	fmt.Fprintln(os.Stderr, "running zkc (this decodes 780,000 bytes)...")
