// Runner for the bench_brotli_c micro-benchmark.
...
const (
	...
	r5Bin         = "zig-out/bin/bench-brotli-c"
	r5JSON        = "zig-out/bin/bench-brotli-c.json"
	tailLimit     = 40
	defaultOutput = "bench/bench-brotli-c.csv"
...
var phases = []struct {
	...
	{"brotli-11 (C reference v1.2.0)", 10, 11, 12, "brotli_compressed.bin"},
}
