...
const largePCSFixturePath = "../../../zig-out/bench/large-pcs.zig"

var largePCS = flag.Bool("large-pcs", false, "also write the large PCS benchmark fixture")
...
func main() {
	...
	if *largePCS {
		if err := writeLargePCSFixture(); err != nil {
			panic(err)
		}
	}
}
...
func writeLargePCSFixture() error {
	var out bytes.Buffer
	fmt.Fprintln(&out, "// Code generated by verifier-ray/testdata/generate/fri; DO NOT EDIT.")
	fmt.Fprintln(&out)
	fmt.Fprintln(&out, "const verifier_ray = @import(\"verifier_ray\");")
	...
	if err := os.MkdirAll(filepath.Dir(largePCSFixturePath), 0o755); err != nil {
		return err
	}
	return os.WriteFile(largePCSFixturePath, data, 0o644)
}
