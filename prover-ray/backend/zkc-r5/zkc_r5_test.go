...
func TestSszBlobs_LengthPrefixAtInOrigin(t *testing.T) {
	...
	got := zkc_r5.NewDataSection(zkc_r5.DefaultINOrigin, ssz)
	require.Len(t, got, 2)
...
func TestSszBlobs_PayloadAtInOriginPlus8(t *testing.T) {
	...
	got := zkc_r5.NewDataSection(zkc_r5.DefaultINOrigin, payload)
	require.Len(t, got, 2)
...
func TestSszBlobs_EmptySSZ(t *testing.T) {
	...
	got := zkc_r5.NewDataSection(zkc_r5.DefaultINOrigin, nil)
